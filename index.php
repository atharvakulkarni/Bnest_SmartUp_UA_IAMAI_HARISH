...
<body>
<form name="frmRegistration" method="post" action="mailto:yashdares7@gmail.com?subject=Universal_Acceptance">
    <a href="indexh.php"><button type="button">Switch to Hindi!</button></a>
